...
class Halaman1 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val _btnSatu = view.findViewById<Button>(R.id.button2)
        _btnSatu.setOnClickListener {
            ...
            mFragmentManager.beginTransaction().apply {
                replace(
                    R.id.frameContainer,
                    hal2, Halaman2::class.java.simpleName
                )
                addToBackStack(null)
                commit()
            }
        }
        val _btnDua = view.findViewById<Button>(R.id.button3)
        _btnDua.setOnClickListener {
            ...
            mFragmentManager.beginTransaction().apply {
                replace(
                    R.id.frameContainer,
                    hal3, Halaman3::class.java.simpleName
                )
                addToBackStack(null)
                commit()
            }
